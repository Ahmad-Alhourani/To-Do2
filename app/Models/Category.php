<?php
    ...
    class Category extends Model{
        use Sortable, CategoryAttribute, Eloquence, Metable, SoftDeletes, CascadeSoftDeletes , HasSlug ;
        ...
        */
        public function tasks() {
            return $this->belongsToMany(Todo::class,'todo_categories')->whereNull('todo_categories.deleted_at')->withTimestamps();
        }
