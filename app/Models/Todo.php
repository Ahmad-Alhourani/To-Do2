<?php
    ...
    class Todo extends Model{
        use Sortable, TodoAttribute, Eloquence, Metable, SoftDeletes, CascadeSoftDeletes , HasSlug ;
        ...
        */
        public function categories() {
            return $this->belongsToMany(Category::class,'todo_categories')->whereNull('todo_categories.deleted_at')->withTimestamps();
        }
        ...
        */
        public function users() {
            return $this->belongsToMany(Person::class,'comments')->whereNull('comments.deleted_at')->withTimestamps()->withPivot([ 'body',]);
        }
