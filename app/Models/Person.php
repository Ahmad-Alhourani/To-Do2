<?php
    ...
    class Person extends Model{
        use Sortable, PersonAttribute, Eloquence, Metable, SoftDeletes, CascadeSoftDeletes , HasSlug ;
        ...
        */
        public function duties() {
            return $this->belongsToMany(Todo::class,'comments')->whereNull('comments.deleted_at')->withTimestamps()->withPivot([ 'body',]);
        }
