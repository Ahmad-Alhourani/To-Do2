...
class CommentController extends Controller
{
    ...
    */
    public function create()
    {
        ...
        return view('backend.comments.create' ,compact(
    ...
    */
    public function store(CreateComment $request)
    {
        ...
        $obj=$this-> commentRepository->create($request->only( [ "body","person_id","todo_id",]));
        
      event(new CommentCreated($obj));
      return redirect()->route('admin.comment.index')->withFlashSuccess(__('alerts.frontend.comment.saved'));
    }
    ...
    */
    ...
    return redirect()->route('admin.comment.index')->withFlashSuccess(__('alerts.frontend.comment.updated'));
    ...
    */
    public function destroy(Comment $comment)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('alerts.frontend.comment.deleted'));
    }
