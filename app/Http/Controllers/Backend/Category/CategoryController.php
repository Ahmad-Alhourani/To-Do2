...
class CategoryController extends Controller
{
    ...
    */
    public function store(CreateCategory $request)
    {
      ...
      return redirect()->route('admin.category.index')->withFlashSuccess(__('alerts.frontend.category.saved'));
    }
    ...
    */
    public function edit(Category $category)
    {
        ...
        $todos = Todo::all();
        $selectedTodo = [];
        $related_items = TodoCategory::where('category_id', '=', $category->id)->get();
    ...
    */
    ...
    return redirect()->route('admin.category.index')->withFlashSuccess(__('alerts.frontend.category.updated'));
    ...
    */
    public function destroy(Category $category)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('alerts.frontend.category.deleted'));
    }
