...
class PersonController extends Controller
{
    ...
    */
    public function store(CreatePerson $request)
    {
        ...
        $obj=$this-> manRepository->create($request->only( [ "name","email","sms",]));
        
      event(new PersonCreated($obj));
      return redirect()->route('admin.man.index')->withFlashSuccess(__('alerts.frontend.man.saved'));
    }
    ...
    */
    ...
    return redirect()->route('admin.man.index')->withFlashSuccess(__('alerts.frontend.man.updated'));
    ...
    */
    public function destroy(Person $man)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('alerts.frontend.man.deleted'));
    }
