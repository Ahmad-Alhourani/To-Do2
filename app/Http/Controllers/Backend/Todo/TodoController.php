...
class TodoController extends Controller
{
    ...
    */
    public function create()
    {
       ...
       $selectedCategory = [];
        ...
        return view('backend.todos.create' ,compact(
    ...
    */
    public function store(CreateTodo $request)
    {
        ...
        $obj=$this-> todoRepository->create($request->only( [ "title","description","deadline",]));
      ...
      return redirect()->route('admin.todo.index')->withFlashSuccess(__('alerts.frontend.todo.saved'));
    }
    ...
    public function edit(Todo $todo)
    {
        ...
        foreach ($related_items as $related_item) {
           array_push($selectedCategory, $related_item->category_id);
                ...
                return view('backend.todos.edit',compact(
    ...
    */
    ...
    return redirect()->route('admin.todo.index')->withFlashSuccess(__('alerts.frontend.todo.updated'));
    ...
    */
    public function destroy(Todo $todo)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('alerts.frontend.todo.deleted'));
    }
