...
class PersonAPIController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $men = $this->personRepository->all();
        return response()->json(['data' => $men,'People retrieved successfully']);
    }
   ...
   //   $person = $this->personRepository->findByField('id',$id);
        ...
        return response()->json(['data' => $person,'Person retrieved successfully']);
