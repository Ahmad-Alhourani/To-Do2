...
class CommentAPIController extends Controller
{
    ...
    public function __construct(CommentRepository $commentRepo,Comment $comment)
    {
    ...
    */
    public function index(Request $request)
    {
        ...
        return response()->json(['data' => $comments,'Comments retrieved successfully']);
    }
   ...
   //   $comment = $this->commentRepository->findByField('id',$id);
        ...
        return response()->json(['data' => $comment,'Comment retrieved successfully']);
