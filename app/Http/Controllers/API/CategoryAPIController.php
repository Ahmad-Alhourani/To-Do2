...
class CategoryAPIController extends Controller
{
    ...
    public function __construct(CategoryRepository $categoryRepo,Category $category)
    {
    ...
    */
    public function index(Request $request)
    {
        ...
        return response()->json(['data' => $categories,'Categorys retrieved successfully']);
    }
   ...
   //   $category = $this->categoryRepository->findByField('id',$id);
        ...
        return response()->json(['data' => $category,'Category retrieved successfully']);
